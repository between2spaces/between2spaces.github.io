...
var WalkingAction = WalkingAction || function () {};
...
(function (internal) {
	 ...
	 * WalkingAction
	 * 
	 * @param {WalkingAction} destination
	 * @return {WalkingAction}
	 */
	WalkingAction = function (destination) {
		
		var instance = Action({ type: 'WalkingAction' });
	...
	WalkingAction.update = function (destination) {
...
} (WalkingAction.internal || {}));


export default WalkingAction;