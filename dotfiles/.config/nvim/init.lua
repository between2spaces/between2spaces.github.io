...
vim.keymap.set('n', '<leader>cd', vim.diagnostic.open_float, { desc = 'Find diagnostic message' })
...
vim.keymap.set('n', '<leader>cf', "mmgggqG'm", { desc = 'Format' })
...
vim.keymap.set('n', '<leader>f?', require('telescope.builtin').oldfiles, { desc = 'Find recently opened' })
vim.keymap.set('n', '<leader><tab>', require('telescope.builtin').buffers, { desc = 'Find buffers' })
...
vim.keymap.set('n', '<leader><leader>', require('telescope.builtin').keymaps, { desc = 'Find keymaps' })
